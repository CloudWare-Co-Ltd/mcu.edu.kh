...
const actions = {
    async fetchBanner({commit}){
        try {
            const res = await fetch('https://api.mcu.edu.kh/api/get-banner');
    ...
    async fetchCollaboration({commit}){
        try {
            const res = await fetch('https://api.mcu.edu.kh/api/get-collaboration');
            const data = await res.json();
    ...
    async fetchProject({commit}){
        try {
            const res = await fetch('https://api.mcu.edu.kh/api/get-project');
            const data = await res.json();
    ...
    async fetchAoc({commit}){
        try {
            const res = await fetch('https://api.mcu.edu.kh/api/get-aoc');
            const data = await res.json();
            commit('SET_AOC',data)
        }catch (e) {
            return false
    ...
    async fetchAbout({commit}){
        try {
            const res = await fetch('https://api.mcu.edu.kh/api/get-about');
            const data = await res.json();
    ...
    async fetchGalleries({commit}){
        try {
            const res = await fetch('https://api.mcu.edu.kh/api/get-gallery');
            const data = await res.json();
    ...
    async fetchCorporation({commit}){
        try {
            const res = await fetch('https://api.mcu.edu.kh/api/get-corporation');
            const data = await res.json();
    ...
    async fetchNews({commit}){
        try {
            const res = await fetch('https://api.mcu.edu.kh/api/get-news');
            const data = await res.json();
    ...
    async fetchVideos({commit}){
        try {
            const res = await fetch('https://api.mcu.edu.kh/api/get-videos');
            const data = await res.json();
